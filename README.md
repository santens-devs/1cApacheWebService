...
```
Один web-сервер модет одновременно обслуживать несколько клиентов (конфигураторов) и работать с несколькими хранилищами конфигураций:
![image](https://user-images.githubusercontent.com/1051804/142340595-137f38a6-9047-4c88-991c-6ea959637dd8.png)
